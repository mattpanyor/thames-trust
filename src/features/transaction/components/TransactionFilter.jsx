          ...
          <div className="flex items-center">
            ...
            <div
              ...
              style={{
                ...
                margin: 0,
                transform: 'translate3d(884px, 3255.6px, 0px)'
              }}>
          ...
          <div className="flex items-center space-x-4">
            <div className="relative">
              ...
              <input
                name="start"
                type="text"
                className="datepicker-input block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 pl-10 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
                placeholder="From"
              />
            </div>
            <div className="relative">
